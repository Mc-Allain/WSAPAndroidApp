...
public class AdminExpoAdapter extends RecyclerView.Adapter<AdminExpoAdapter.ViewHolder> {
    ...
    public AdminExpoAdapter(Context context, List<Expo> expos) {
        this.expos = expos;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = layoutInflater.inflate(R.layout.custom_admin_expo_layout, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        imgMoreInfo.setOnClickListener(view -> {
            if (adapterListener != null) adapterListener.onClick(expo);
        });

        imgUpdate.setOnClickListener(view -> {
            if (adapterListener != null) adapterListener.onEdit(expo);
        });

        imgDelete.setOnClickListener(view -> {
            if (adapterListener != null) adapterListener.onDelete(expo);
        });

        imgMove.setOnClickListener(view -> {
            if (adapterListener != null) adapterListener.onMove(expo);
        });
    }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView tvExpoPostTitle, tvDescription, tvSchedule;
    ...
    public interface AdapterListener {
        void onClick(Expo expo);
        void onEdit(Expo expo);
        void onDelete(Expo expo);
        void onMove(Expo expo);
    }
