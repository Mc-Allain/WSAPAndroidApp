...
public class ChangeUserRoleDialog {
    ...
    public ChangeUserRoleDialog(Context context) {
    ...
    private void setDialog() {
        ...
        dialog.setContentView(R.layout.dialog_change_user_role_layout);
        ...
        btnConfirm.setOnClickListener(view -> {
            if (currentSelectedIndex >= userRoleIndex && dialogListener != null)
                dialogListener.onFailed();
            else if (dialogListener != null)
                dialogListener.onSelect(currentSelectedIndex);
        });
